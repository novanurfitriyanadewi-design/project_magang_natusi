    ...
    $menus = match ($role) {
        ...
        'admin_peserta' => [
            ...
            [
                'label' => 'Peserta Magang',
                'icon' => 'users',
                'match' => 'admin-peserta.peserta.*',
                'tour' => 'peserta-magang',
                'children' => [
                    ['label' => 'Data Peserta Magang', 'route' => 'admin-peserta.peserta.index', 'match' => 'admin-peserta.peserta.*', 'tour' => 'internship-participants'],
                    ['label' => 'Absensi Peserta Magang', 'route' => 'admin-peserta.absensi.index', 'match' => 'admin-peserta.absensi.*', 'tour' => 'attendance-data'],
                    ['label' => 'Pembayaran Sumbangan', 'route' => 'admin-peserta.pembayaran.index', 'match' => 'admin-peserta.pembayaran.*', 'tour' => 'pembayaran-peserta'],
                    ['label' => 'Kelola Tugas', 'route' => 'admin-peserta.tugas.index', 'match' => 'admin-peserta.tugas.*', 'tour' => 'manage-tasks'],
                    ['label' => 'Pengumpulan Tugas', 'route' => 'admin-peserta.pengumpulan-tugas.index', 'match' => 'admin-peserta.pengumpulan-tugas.*', 'tour' => 'task-submissions'],
                ],
            ],
            [
                'label' => 'Laporan',
                ...
                'tour' => 'reports',
                'children' => [
                    ['label' => 'Peserta Magang', 'route' => 'admin-peserta.laporan-peserta.index', 'match' => 'admin-peserta.laporan-peserta.*', 'tour' => 'report-participants'],
                    ['label' => 'Absensi Peserta', 'route' => 'admin-peserta.laporan.absensi', 'match' => 'admin-peserta.laporan.absensi', 'tour' => 'report-attendance'],
                    ['label' => 'Penugasan', 'route' => 'admin-peserta.laporan.penugasan', 'match' => 'admin-peserta.laporan.penugasan', 'tour' => 'report-tasks'],
                    ['label' => 'Pembayaran Peserta', 'route' => 'admin-peserta.laporan.pembayaran', 'match' => 'admin-peserta.laporan.pembayaran', 'tour' => 'report-payments'],
                ],
            ],
            ['label' => 'Kelola Profil', 'route' => 'profile.edit', 'match' => 'profile.*', 'icon' => 'profile', 'tour' => 'profile'],
        ],
        'admin_karyawan' => [
            ...
            [
                'label' => 'Karyawan',
                'icon' => 'users',
                'match' => 'admin-karyawan.karyawan.*',
                'tour' => 'karyawan',
                'children' => [
                    ['label' => 'Data Karyawan', 'route' => 'admin-karyawan.karyawan.index', 'match' => 'admin-karyawan.karyawan.*', 'tour' => 'data-karyawan'],
                    ['label' => 'Absensi Karyawan', 'route' => 'admin-karyawan.absensi-karyawan.index', 'match' => 'admin-karyawan.absensi-karyawan.*', 'tour' => 'absensi-karyawan'],
                    ['label' => 'Pembayaran Gaji', 'route' => 'admin-karyawan.pembayaran-karyawan.index', 'match' => 'admin-karyawan.pembayaran-karyawan.*', 'tour' => 'pembayaran-karyawan'],
                    ['label' => 'Pengajuan Resign', 'route' => 'admin-karyawan.resign.index', 'match' => 'admin-karyawan.resign.*', 'tour' => 'resign'],
                ],
            ],
            ...
            [
                ...
                'tour' => 'reports',
                'children' => [
                    ['label' => 'Karyawan', 'route' => 'admin-karyawan.laporan-karyawan.index', 'match' => 'admin-karyawan.laporan-karyawan.*', 'tour' => 'report-karyawan'],
                    ['label' => 'Absensi Karyawan', 'route' => 'admin-karyawan.laporan.absensi-karyawan', 'match' => 'admin-karyawan.laporan.absensi-karyawan', 'tour' => 'report-attendance-karyawan'],
                    ['label' => 'Pembayaran Karyawan', 'route' => 'admin-karyawan.laporan.pembayaran-karyawan', 'match' => 'admin-karyawan.laporan.pembayaran-karyawan', 'tour' => 'report-payments-karyawan'],
                ],
            ],
            ['label' => 'Kelola Profil', 'route' => 'profile.edit', 'match' => 'profile.*', 'icon' => 'profile', 'tour' => 'profile'],
        ],
