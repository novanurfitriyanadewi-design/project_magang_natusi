...
<div class="p-6">
    ...
    <div class="mb-6">
        ...
        <p class="mt-1 text-sm text-slate-500">
            Perbarui informasi dan penerima pengumuman.
        </p>
    </div>
    ...
    <form
        action="{{ route('admin-karyawan.pengumuman.update', $pengumuman) }}"
        method="POST"
        ...
        <div class="space-y-5">
            ...
            <div>
                ...
                >
                    ...
                    <option
                        value="umum"
                        {{ old('kategori', $pengumuman->kategori) === 'umum' ? 'selected' : '' }}
                    >
                        Umum
                    </option>
                    ...
                    <option
                        value="penting"
                        {{ old('kategori', $pengumuman->kategori) === 'penting' ? 'selected' : '' }}
                    >
                        Penting
                    </option>
                    ...
                    <option
                        value="acara"
                        {{ old('kategori', $pengumuman->kategori) === 'acara' ? 'selected' : '' }}
                    >
                        Acara
                    </option>
                </select>
            ...
            <div>
                ...
                >
                    ...
                    <option
                        value="umum"
                        {{ old('target', $target) === 'umum' ? 'selected' : '' }}
                    >
                        Semua Karyawan
                    </option>
                    ...
                    <option
                        value="individu"
                        {{ old('target', $target) === 'individu' ? 'selected' : '' }}
                    >
                        Karyawan Tertentu
                    </option>
            ...
            <div
                id="pilihan-karyawan"
                class="{{ old('target', $target) === 'individu' ? '' : 'hidden' }}"
            >
                                ...
                                >
                                    ...
                                    <input
                                        ...
                                        @if(
                                            in_array(
                                                $item->id_karyawan,
                                                old('karyawan_id', $selectedKaryawan)
                                            )
                                        )
                                            checked
                                        @endif
