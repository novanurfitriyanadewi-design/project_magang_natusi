...
<div class="space-y-6">
    <section class="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
        ...
        <div class="flex gap-2">
            <a href="{{ route('admin-karyawan.absensi-karyawan.create') }}" class="flex items-center gap-2 rounded-lg bg-emerald-600 px-4 py-2.5 text-sm font-bold text-white shadow-md transition hover:bg-emerald-700 active:scale-95"><span class="material-symbols-outlined text-[20px]">add</span>Tambah</a>
                        ...
                        <tr class="transition-colors hover:bg-slate-50/50">
                            ...
                            <td class="px-6 py-4 text-right">
                                <div class="flex items-center justify-end gap-1">
                                    <a href="{{ route('admin-karyawan.absensi-karyawan.show', $item) }}" class="rounded-lg border border-sky-200 bg-sky-50 px-2.5 py-1.5 text-xs font-bold text-sky-700 transition hover:bg-sky-100">
                                        Detail
                                    </a>
                                    <a href="{{ route('admin-karyawan.absensi-karyawan.edit', $item) }}" class="rounded-lg border border-amber-200 bg-amber-50 px-2.5 py-1.5 text-xs font-bold text-amber-700 transition hover:bg-amber-100">
                                        Edit
                                    </a>
