...
<div class="mx-auto max-w-3xl space-y-6">
    <section class="flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
        ...
        <div class="flex gap-2">
            <a href="{{ route('admin.absensi-karyawan.edit', $absensiKaryawan) }}" class="inline-flex items-center gap-2 rounded-lg bg-amber-500 px-4 py-2.5 text-sm font-bold text-white shadow-md transition hover:bg-amber-600 active:scale-95">
    ...
    <section class="rounded-xl border border-slate-200 bg-white shadow-sm overflow-hidden">
        ...
        <div class="flex items-center justify-end gap-3 border-t border-slate-100 bg-slate-50 px-6 py-4">
            <a href="{{ route('admin.absensi-karyawan.index') }}" class="rounded-lg border border-slate-200 bg-white px-4 py-2.5 text-sm font-bold text-slate-600 transition hover:bg-slate-100">
                Kembali
            </a>
            <a href="{{ route('admin.absensi-karyawan.edit', $absensiKaryawan) }}" class="rounded-lg bg-gradient-to-r from-amber-500 to-orange-500 px-4 py-2.5 text-sm font-bold text-white shadow-md transition hover:-translate-y-0.5">
                Edit Data
            </a>
        </div>
    </section>
