...
>
    ...
    <form method="GET" class="mt-5 flex flex-wrap items-end gap-4 rounded-2xl border border-slate-100 bg-slate-50 p-4">
        ...
        <a href="{{ route('admin.karyawan.index') }}" class="px-2 text-sm font-bold text-sky-700 hover:underline">Reset Filter</a>
    </form>
                            ...
                            <td class="whitespace-nowrap px-5 py-4">
                                <div class="flex justify-center gap-2">
                                    ...
                                    <button
                                        ...
                                        @click="openEdit({
                                            action: @js(route('admin.karyawan.update', $karyawan->id_karyawan)),
