...
<div class="space-y-6">
    ...
    <section class="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
        <form method="GET" action="{{ route('admin.laporan.absensi-karyawan') }}" class="flex flex-wrap items-end gap-4">
            <div>
            ...
            <a href="{{ route('admin.laporan.absensi-karyawan.export', request()->query()) }}" class="inline-flex items-center gap-2 rounded-xl bg-slate-900 px-5 py-2.5 text-sm font-bold text-white shadow-sm hover:bg-slate-800">
