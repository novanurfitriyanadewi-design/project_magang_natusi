...
class NotifikasiController extends Controller
{
    ...
    public function index(Request $request): View
    {
        ...
        return view('admin-peserta.notifikasi.index', compact('notifikasis'));
    }
    ...
    {
        return view('admin-peserta.notifikasi.create');
    }
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        return redirect()->route('admin-peserta.notifikasi.index')
    ...
    public function show(Notifikasi $notifikasi): View
    {
        ...
        return view('admin-peserta.notifikasi.show', compact('notifikasi'));
    }
    ...
    {
        $notifikasi->load('user');
        return view('admin-peserta.notifikasi.edit', compact('notifikasi'));
    }
