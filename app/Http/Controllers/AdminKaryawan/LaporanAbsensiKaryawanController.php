...
class LaporanAbsensiKaryawanController extends Controller
{
    public function index(Request $request): View
    {
        ...
        // PERBAIKAN: Jika view disimpan di folder admin-karyawan, ubah menjadi 'admin-karyawan.laporan.absensi-karyawan'
        return view('admin-karyawan.laporan.absensi-karyawan', compact(
            'jabatanList',
            'jabatan',
            'search',
            'dariTgl',
